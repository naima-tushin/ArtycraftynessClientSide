    ...
    return (
        <div className='flex flex-col items-center'>
            ...
            <div className='flex justify-center'>
                ...
                <button onClick={() => setCustomizationFilter('all')} className={`my-4 text-right pr-6  font-bold text-xl ${customizationFilter === 'all' ? 'selected underline' : ''}`}>All</button>
                <button onClick={() => setCustomizationFilter('Yes')} className={`my-4 text-right pr-6  font-bold text-xl ${customizationFilter === 'Yes' ? 'selected underline' : ''}`}>Customized</button>
                <button onClick={() => setCustomizationFilter('No')} className={`my-4 text-right pr-6  font-bold text-xl ${customizationFilter === 'No' ? 'selected underline' : ''}`}>Not Customized</button>
